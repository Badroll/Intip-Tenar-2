                ...
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            ...
                            <i><div id="message" class="pw-error"></div></i>
                        </div>
                    </div>
            ...
            <div class="modal-body">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        ...
                        <i><div id="message_" class="pw-error"></div></i>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#password').on('keyup', function () {
            ...
            if (minLength && hasUpperCase && hasLowerCase && hasNumber && hasSpecialChar) {
                pwValid = true
                message.text('Password valid.').removeClass('pw-error').addClass('pw-valid');
            } else {
                var errors = [];
                if (!minLength) errors.push("minimal 8 karakter");
                if (!hasUpperCase) errors.push("terdapat huruf besar");
                if (!hasLowerCase) errors.push("terdapat huruf kecil");
                if (!hasNumber) errors.push("terdapat angka");
                if (!hasSpecialChar) errors.push("terdapat karakter khusus");
                pwValid = false
                message.text('Password harus: ' + errors.join(', ')).removeClass('pw-valid').addClass('pw-error');
            }
        });
    ...
    function simpan(){
        ...
        if(!pwValid){
            notify("e", "Mohon isikan password sesuai kriteria")
            return
        }
