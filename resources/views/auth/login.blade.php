...
<form id="form-login" action="{{ url('auth/login')  }}" method="POST" class="form-valid" autocomplete="off">
	...
	<div class="panel panel-body login-form" style="">
		<div class="text-center">
			...
			<h4 class="content-group"><b>LOGIN INTIP RUDIMARANG</b></h4>
			<h6 class="content-group" style="margin-top: -20px;"><b>INFORMASI TERPADU</b></h6>
		...
		<div class="form-group">
			<button type="submit" class="btn btn-primary btn-block" style="background-color:#ffcd05; border-color:#ffcd05;">Login <i class="icon-circle-right2 position-right"></i></button>
		</div>
